				...
				<div id="sidebar">
						...
						<ul id="cats">
							...
							<?php 
								...
								echo "<br><p style='text-align:center';><img src='customer_images/$c_image' width='150' height='150'/></p>";
									...
									if (!isset($_GET['change_pass'])) {
										if (!isset($_GET['delete_account'])) {
											...
											echo "
												...
												<b>You can see your orders progress by clicking this <a href='my_account.php?my_orders'>link</a;
											";
