...
<div>
	...
	<form action="" method="post">
		...
		<table width="500" align="center" bgcolor="skyblue">
			...
			<tr align="center">
				<td colspan="3"><a href="checkout.php?forgot_pass">Forgot Password
				</a></td>
			</tr>
		...
		<h2 style="float:right; padding-right:20px;"><a href="customer_register.php" 
	...
	<?php 
		...
		if (isset($_POST['login'])) {
			...
			if ($check_customer == 0) {
				...
				echo "<script>alert('Password or rmail is incorrect, please try 
				again!')</script>";
