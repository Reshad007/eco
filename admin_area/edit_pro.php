...
?>
		...
		if (isset($_GET['edit_pro'])) {
			...
			$row_pro = mysqli_fetch_array($run_pro); 
				...
				// getting product category title
	...
	<html>
		...
		<table align="center" width="795" border="2" bgcolor="orange">
					...
					<tr>
						...
						<td><input type="file" name="product_image"> <img src="product_images/<?php echo $pro_image; ?>" width= "60" height="60" alt=""></td>
					</tr>
					...
					<tr align= "center">
						<td colspan="7"><input type="submit" name="update_product"
